        ...
        <TabControl HorizontalAlignment="Left" Height="730" Margin="10,0,0,0" VerticalAlignment="Top" Width="1260">
            ...
            <TabItem Name="DeployFirebox" Header="   Deploy FireboxV   ">
                <Grid Background="#FFE5E5E5">
                    ...
                    <TextBox Name="TextBoxFireboxExternalIp" HorizontalAlignment="Left" Height="22" Margin="760,32,0,0" Text="172.16.25.100" VerticalAlignment="Top" Width="180"/>
                    <TextBox Name="TextBoxFireboxExternalIpGatewayCIDR" HorizontalAlignment="Left" Height="22" Margin="760,65,0,0" Text="172.16.25.1/24" VerticalAlignment="Top" Width="180"/>
            ...
            <TabItem Name="TabItemDeployDC" Header="   Deploy DC   ">
                <Grid Background="#FFE5E5E5">
                    ...
                    <TextBox Name="TextBoxDomainNetbiosName"  HorizontalAlignment="Left" Height="22" Margin="200,28,0,0" Text="$DomainNetbiosName" VerticalAlignment="Top" Width="180" ToolTip="Fill in Domain NetbiosName - Please limit to 15 Characters"/>
                    ...
                    <TextBox Name="TextBoxSafeModeAdministratorPassword" HorizontalAlignment="Left" Height="22" Margin="200,127,0,0" Text="$('*'*35)" VerticalAlignment="Top" Width="180" ToolTip="Fill in Password - Please Use Complex Password"/>
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Margin="2,250,0,0" Height="380" Width="1256"  HorizontalScrollBarVisibility="Disabled">
            ...
            <TabItem Name="TabItemDeployOU" Header="   Deploy OU   ">
                <Grid Background="#FFE5E5E5">
                    ...
                    <TextBox Name="TextBoxClearmediaAdminPassword" HorizontalAlignment="Left" Height="22" Margin="200,94,0,0" Text="$('*'*35)" VerticalAlignment="Top" Width="180" ToolTip="Fill in Password - Please Use Complex Password"/>
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Margin="2,250,0,0" Height="380" Width="1256"  HorizontalScrollBarVisibility="Disabled">
...
# Init ( WPF - Windows Presentation Framework ) Functions
	Function DeployFireboxStart {
		Param($syncHash,$FireboxIpAddress,$FireboxAdminUserName,$FireboxAdminPassword,$FireboxExternalIpCIDR,$FireboxExternalIpGateway)
	...
	Function DeployDcStart {
		Param($syncHash,$SafeModeAdministratorPassword,$DnsForwarder,$DomainNetbiosName,$DomainDnsName)
        $Runspace = [runspacefactory]::CreateRunspace()
        $Runspace.ApartmentState = "STA"
        $Runspace.ThreadOptions = "ReuseThread"
        $Runspace.Open()
...
# Init ( WPF - Windows Presentation Framework ) Actions
    ...
    $syncHash.ButtonDeployDcStart.Add_Click({
	    ...
	    DeployDcStart -syncHash $syncHash -SafeModeAdministratorPassword $syncHash.TextBoxSafeModeAdministratorPassword.Text -DnsForwarder $syncHash.TextBoxDnsServerForwarders.Text -DomainNetbiosName $SyncHash.TextBoxDomainNetbiosName.Text -DomainDnsName $SyncHash.TextBoxDomainDnsName.Text
        # $SyncHash.host.ui.WriteVerboseLine($SyncHash.TextBoxDomainNetbiosName.Text)
        })
