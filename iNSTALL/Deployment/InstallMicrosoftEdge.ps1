...
# Install Microsoft Edge for business version 134.0.3124.68
...
Invoke-Expression -Command '& C:\ProgramData\chocolatey\choco install microsoft-edge --version=134.0.3124.68 -y -f'
