        ...
        <TabControl HorizontalAlignment="Left" Height="730" Margin="10,0,0,0" VerticalAlignment="Top" Width="1260">
            ...
            <TabItem Name="TabItemDeployOU" Header="Deploy OU" Margin="64,0,-120,0">
                <Grid Background="#FFE5E5E5">
                    ...
                    <TextBox Name="TextBoxClearmediaAdminPassword" HorizontalAlignment="Left" Height="22" Margin="180,94,0,0" Text="$('*'*18)" VerticalAlignment="Top" Width="180"/>
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Margin="2,250,0,0" Height="380" Width="1256"  HorizontalScrollBarVisibility="Disabled">
            ...
            <TabItem Name="TabItemDelployGPO" Header="Deploy Standard GPO" Margin="124,0,-180,0">
                <Grid Background="#FFE5E5E5">
                    <CheckBox Name="checkBox1" Content="Copy ADM(X) Files to Local and Central ADM(X) Store" HorizontalAlignment="Left" Margin="12,12,0,0" VerticalAlignment="Top" IsChecked="True"/>
                    ...
                    <TextBox Name="TextBoxTemplateSourcePath" Margin="135,36,0,0" Text="C:\Install\GPO\Templates" Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="275"/>
                    ...
                    <TextBox Name="TextBoxRdsOuPath" Margin="90,84,0,0" Text="$RdsOuPath" Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="320"/>
                    ...
                    <TextBox Name="TextBoxUsersOuPath" Margin="650,84,0,0" Text="$UsersOuPath" Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="250"/>
                    ...
                    <TextBox Name="TextBoxOstPath" Margin="650,199,0,0" Text='D:\Users\%USERNAME%' Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="250"/>
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Margin="2,250,0,0" Height="380" Width="1256"  HorizontalScrollBarVisibility="Disabled">
            ...
            <TabItem Name="TabItemFolderRedirection" Header="Deploy Folder Redirection" Margin="184,0,-240,0">
                <Grid Background="#FFE5E5E5">
                    ...
                    <TextBox Name="TextBoxDocumentsPath" Margin="110,36,0,0" Text="E:\USERS\%USERNAME%\Documents" Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="300"/>
                    ...
                    <TextBox Name="TextBoxMusicPath" Margin="110,89,0,0" Text="E:\USERS\%USERNAME%\Music" Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="300"/>
                    ...
                    <TextBox Name="TextBoxPicturesPath" Margin="110,142,0,0" Text="E:\USERS\%USERNAME%\Pictures" Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="300"/>
                    ...
                    <TextBox Name="TextBoxVideosPath" Margin="110,195,0,0" Text="E:\USERS\%USERNAME%\Videos" Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="300"/>
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Margin="2,250,0,0" Height="380" Width="1256"  HorizontalScrollBarVisibility="Disabled">
            ...
            <TabItem Name="TabItemDeployRDS" Header="Deploy RDS" Margin="244,0,-300,0">
                <Grid Background="#FFE5E5E5">
					...
					<Label Name="LabelOstFolderRootPath" Content="User OST Root Path" HorizontalAlignment="Left" Margin="10,170,0,0" VerticalAlignment="Top"/>
					<Label Name="LabelDataFolderRootPath" Content="User Data Root" HorizontalAlignment="Left" Margin="10,220,0,0" VerticalAlignment="Top"/>
                    ...
                    <TextBox Name="TextBoxAdminPassword" HorizontalAlignment="Left" Height="22" Margin="180,131,0,0" Text="$('*'*15)" VerticalAlignment="Top" Width="180"/>
                    <TextBox Name="TextBoxOstFolderRootPath" Margin="180,170,0,0" Text='D:\Users' Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="180"/>
                    <TextBox Name="TextBoxDataFolderRootPath" Margin="180,220,0,0" Text='E:\Users' Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="180"/>
                    ...
                    <TextBox Name="TextBoxRasLicensePasswordx" HorizontalAlignment="Left" Height="22" Margin="713,98,0,0" Text="$('*'*15)" VerticalAlignment="Top" Width="180" RenderTransformOrigin="0.462,0.455"/>
                    ...
                    <TextBox Name="TextBoxRasKeyx" Margin="713,131,0,0" Text="TRIAL" Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="180"/>
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Margin="2,250,0,0" Height="380" Width="1256"  HorizontalScrollBarVisibility="Disabled">
            ...
            <TabItem Name="TabItemDeployWU" Header="Deploy Windows Updates" Margin="364,0,-398,0">
                <Grid Background="#FFE5E5E5">
                    ...
                    <ComboBox Name="ComboBoxWuDayOfWeek" HorizontalAlignment="Left" Height="26" Margin="713,28,0,0" VerticalAlignment="Top" Width="180" SelectedIndex="1" ToolTip="Select Day from List">
                    ...
                    <ComboBox Name="ComboBoxWuTimeHour" HorizontalAlignment="Left" Height="26" Margin="713,61,0,0" VerticalAlignment="Top" Width="80" SelectedIndex="4" ToolTip="Select Hour from List">
            ...
            <TabItem Name="TabItemDeployUSER" Header="Deploy USER" Margin="402,0,-450,0">
                <Grid Background="#FFE5E5E5">
                    ...
                    <Label Name="LabelDeployUSEROstFolderRootPath" Content="User OST Root Path" HorizontalAlignment="Left" Height="28" Margin="10,127,0,0" VerticalAlignment="Top" Width="165"/>
                    <Label Name="LabelDeployUSERDatatFolderRootPath" Content="User Data Root Path" HorizontalAlignment="Left" Height="28" Margin="10,160,0,0" VerticalAlignment="Top" Width="165"/>
                    ...
                    <Label Name="LabelUserPassword" Content="User Password" HorizontalAlignment="Left" Height="28" Margin="550,160,0,0" VerticalAlignment="Top" Width="165"/>
                    ...
                    <TextBox Name="TextBoxDeployUSEROstFolderRootPath" Margin="180,127,0,0" Text='D:\Users' Height="20" HorizontalAlignment="Left" VerticalAlignment="Top" Width="180"/>
                    <TextBox Name="TextBoxDeployUSERUserDataFolderRootPath" Margin="180,160,0,0" Text='E:\Users' Height="22" HorizontalAlignment="Left" VerticalAlignment="Top" Width="180"/>
                    ...
                    <TextBox Name="TextBoxUserPassword" HorizontalAlignment="Left" Height="22" Margin="713,164,0,0" Text="$('*'*15)" VerticalAlignment="Top" Width="180"/>
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Margin="2,250,0,0" Height="380" Width="1256"  HorizontalScrollBarVisibility="Disabled">
...
# Init Close ( WPF - Windows Presentation Framework ) Process on Exit
