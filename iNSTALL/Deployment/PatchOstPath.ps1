<#
	...
	.DESCRIPTION
		...
		OST Must Be Enabled
    	.EXAMPLE
        	PatchOstPath.ps1 -OstPath "D:\DATA\$Env:UserName\$Env:UserName.ost" -MapiProfile 'Outlook'
	#>
param (
	[Parameter(Position=0,Mandatory=$false)][STRING]$OstPath = "D:\DATA\$Env:UserName\$Env:UserName.ost",
