...
get-childitem -path "c:\install" -Recurse  | Remove-Item -Force -Recurse -Verbose
Copy-Item -Path "$ENV:TEMP\Template\BizzCloudWinTemplates-master\iNSTALL\*" -Destination 'c:\iNSTALL' -Force -Verbose
# Cleanup Temp Folder
