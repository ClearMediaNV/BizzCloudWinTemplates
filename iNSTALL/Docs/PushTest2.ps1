...
[XML]$XAML = @"
    ...
    <Grid>
        <TabControl HorizontalAlignment="Left" Height="730" Margin="10,0,0,0" VerticalAlignment="Top" Width="1260">
            ...
            <TabItem Name="TabItemDeployO365" Header="Deploy O365" Margin="364,0,-420,0">
                <Grid Background="#FFE5E5E5">
                    ...
                    <RadioButton Name="RadioButton3" Content="O365BusinessRetail 32 Bit" HorizontalAlignment="Left" Height="22" Margin="10,94,0,0" VerticalAlignment="Top" ClickMode="Press" IsChecked="False"/>
                    <RadioButton Name="RadioButton4" Content="O365BusinessRetail 64 Bit" HorizontalAlignment="Left" Height="22" Margin="10,127,0,0" VerticalAlignment="Top" ClickMode="Press" IsChecked="False"/>

					<CheckBox Name="CheckBoxExcludeApp" Content="Exclude Teams App" HorizontalAlignment="Left" Height="22" Margin="10,193,0,0" VerticalAlignment="Top" IsChecked="False"/>
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Margin="2,250,0,0" Height="380" Width="1256"  HorizontalScrollBarVisibility="Disabled">
