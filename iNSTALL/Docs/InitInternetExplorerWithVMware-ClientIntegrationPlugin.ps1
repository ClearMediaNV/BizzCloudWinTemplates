# Kill IEXPLORE.exe
$Out = While ( Get-Process -Name 'iexplore' -ErrorAction SilentlyContinue) { Get-Process -Name 'iexplore' -ErrorAction SilentlyContinue | ForEach-Object { $_.CloseMainWindow() } ; Start-Sleep -Milliseconds 250 }
