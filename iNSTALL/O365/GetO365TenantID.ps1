...
$ScriptBlockCspDelegation = {
    $Url = 'https://admin.microsoft.com/Adminportal/Home?invType=ResellerRelationship&partnerId=f59f16d4-ed58-42e1-92c1-af863f919035&msppId=0#/partners/invitation'
    Start-Process $Url
    }
